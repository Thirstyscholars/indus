...
2,		// Padding
'Null',	// Background ('color','transparent','[image_source]')
'Null',	// OVER Background
'#000000',	// Color
'#E99600',	// OVER Color
...
'#006600',	// ItemsSeparatorColor ('color','transparent')
...
0,		// Padding
'#d3d3d3',	// Background ('color','transparent','[image_source]')
'',		// IEfilter (only transition filters work well - not static filters)
''		// Custom additional CSS for the menu box (valid CSS)
],[
// MENU ITEMS STYLE
...
'solid',	// BorderStyle (CSS valid values except 'none')
'solid',	// OVER BorderStyle
'#d3d3d3',	// BorderColor ('color')
'#d3d3d3',	// OVER BorderColor
5,		// Padding
'#C4E1C4',	// Background ('color','transparent','[image_source]')
'#005300',	// OVER Background
'#000000',	// Color
'#ffffff',	// OVER Color
'12px',		// FontSize (values in CSS valid units - %,em,ex,px,pt)
'verdana,arial,helvetica,sans-serif',	// FontFamily
...
'solid',		// VISITED BorderStyle
'#C4E1C4',		// VISITED BorderColor
'#C4E1C4',		// VISITED Background
'#000000',		// VISITED Color
'none',			// VISITED TextDecoration
'[v_arrow.gif]',	// VISITED SubMenuImageSource
'solid',		// CURRENT BorderStyle
'#C4E1C4',		// CURRENT BorderColor
'#C4E1C4',		// CURRENT Background
'#000000',		// CURRENT Color
'none',			// CURRENT TextDecoration
...
c_menus['MenuSub1']=[ // the UL element with id="MenuSub1"
[
// MAIN-MENU FEATURES
...
0,		// Y SubMenuOffset
'600px',		// Width (values in CSS valid units - px,em,ex) (matters for main menu with 'vertical' ItemsArrangement only)
